...
def getWeather():
    if area == "NO":
        ...
        location_id = json.loads(requests.get(url='https://geoapi.qweather.com/v2/city/lookup?lang=zh&key='+os.environ["QWEATHER")+'&location='+ area, headers=hea).text)['location'][0]['id']
